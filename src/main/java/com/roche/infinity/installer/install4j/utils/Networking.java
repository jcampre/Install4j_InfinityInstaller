...
public class Networking {
	...
	public static int getAvailablePort(int startPort, int numMaxPorts) {
		...
		for (int port=startPort; port < startPort+numMaxPorts;port++) {
	        try {
				...
				port = s.getLocalPort();
				s.close();
				LoggerManager.getInstance(Networking.class).info(Networking.class.getSimpleName(), "Set port: " + s.getLocalPort());
		...
		LoggerManager.getInstance(Networking.class).info(Networking.class.getSimpleName(), "No free port found");
	...
	public static int getAvailablePort() {
		...
		try {
			...
			LoggerManager.getInstance(Networking.class).error(Networking.class.getSimpleName(), e.getLocalizedMessage(), e);
		}
